...
function iHeartYou() {
  ...
  if (window.location.hash) {
    ...
    vtext.textContent = "a lovely message from nicky case to you <3";
  }
...
var yourCode = document.getElementById("your-code");
function linkChangey() {
  if (yourMessage.value == "") {
    ...
    yourCode.value = encodeURIComponent(encryptString(yourMessage.value));
  }
}
